...
1. In RStudio, open the newly-created R notebook file `arithmetic_quiz_final.Rmd`.

1. Run the code in the notebook chunk by chunk.
...
1. Avoid using newlines in your text strings as these will also format incorrectly
